...
try {
    $stmt = $db->prepare("INSERT INTO person (name, email, year, gender, limbs, bio) VALUES (?, ?, ?, ?, ?, ?);");
    $stmtErr=$stmt -> execute([$_POST['name'], $_POST['email'], $_POST['year'], $_POST['gender'], $_POST['limbs'], $_POST['bio']]);
